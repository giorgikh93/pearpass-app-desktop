...
test.describe.only('Creating Login Item', () => {
  ...
  test('Viewing created item. Verify item details', async () => {
    ...
    // await detailsPage.verifyCustomNoteText('Test Note1')
  })
  ...
  test('Dropdown moves to selected item edit screen', async () => {
    ...
    await detailsPage.fillCreateNewFolderTitleInput('Test Folder') //createfolder-name-v2 placeholder="Enter Name"
    await detailsPage.clickCreateFolderButton()
    // TODO: ADD click on sidebar-folder-all
